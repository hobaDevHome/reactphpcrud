          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
                Every chance we get, we make better choices for all our futures.
                We go to great lengths to make sure our ingredients, packaging
                and processes are as kind to the planet as they are to your
                skin.
              </p>
